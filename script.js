// ===== DECANTS =====
const decants = [
    {name:"9AM DIVE", brand:"AFNAN", img:"9AMDive.jpeg", price:6000,newPrice:5000, discount:true, zoom:1., position:"50% 55%", stock:true},
    {name:"ANSAAM SILVER", brand:"LATTAFA", img:"AnsaamSilver.jpeg", price:8000,newPrice:7000,discount:true, zoom:1., position:"50% 58%", stock:true},
    {name:"9PM ELIXIR", brand:"AFNAN", img:"9PMElixir.jpeg", price:8000,newPrice:7000,discount:true, zoom:1., position:"50% 68%", stock:true},
    {name:"AL NOBLE SAFEER", brand:"LATTAFA", img:"AlNobleSafeer.jpeg", price:5000,newPrice:4000,discount:true, zoom:1., position:"80% 55%", stock:true},
    {name:"AL QIAM GOLD", brand:"LATTAFA", img:"AlQiamGold.jpeg", price:6000,newPrice:5000,discount:true, zoom:1., position:"50% 60%", stock:true},
    {name:"ASAD", brand:"LATTAFA", img:"Asad.jpeg", price:6000,newPrice:5000,discount:true, zoom:1., position:"50% 67%", stock:true},
    {name:"ASAD BOURBON", brand:"LATTAFA", img:"AsadBourbon.jpeg", price:6500,newPrice:5500,discount:true, zoom:1.1, position:"50% 60%", stock:true},
    {name:"EROS FLAME", brand:"VERSACE", img:"ErosFlame.jpeg", price:14000,newPrice:13000,discount:true, zoom:1.2, position:"50% 65%", stock:true},
    {name:"EXTRAVAGANT LOVER", brand:"MAISON ALHAMBRA", img:"Extravagantlover.jpeg", price:7000,newPrice:6000,discount:true, zoom:1.1, position:"50% 67%", stock:true},
    {name:"FAKHAR PLATIN", brand:"LATTAFA", img:"FakharPlatin.jpeg", price:5500,newPrice:4500,discount:true, zoom:1., position:"50% 50%", stock:true},
    {name:"HAWAS ICE", brand:"RASASI", img:"HawasIce.jpeg", price:7500,newPrice:6500,discount:true, zoom:1.1, position:"50% 64%", stock:true},
    {name:"HIS CONFESSION", brand:"MAISON ALHAMBRA", img:"HisConfession.jpeg", price:6500,newPrice:5500,discount:true, zoom:1., position:"50% 47%", stock:true},
    {name:"HONOR & GLORY", brand:"LATTAFA", img:"HonorGlory.jpeg", price:5500,newPrice:4500,discount:true, zoom:1.1, position:"50% 65%", stock:true},
    {name:"INTENSE MAN", brand:"ARMAF", img:"IntenseMan.jpeg", price:6500,newPrice:5500,discount:true, zoom:1., position:"50% 55%", stock:true},
    {name:"ISHQ AL SHUYUKH", brand:"LATTAFA", img:"IshqAlShuyukh.jpeg", price:6000,newPrice:5000,discount:true, zoom:1., position:"50% 63%", stock:true},
    {name:"JASOOR", brand:"LATTAFA", img:"Jasoor.jpeg", price:8000,newPrice:7000,discount:true, zoom:1., position:"50% 65%", stock:true},
    {name:"KHAMRAH QAHWA", brand:"LATTAFA", img:"KhamrahQahwa.jpeg", price:5500,newPrice:4500,discount:true, zoom:1.2, position:"50% 65%", stock:true},
    {name:"MASHRABYA", brand:"LATTAFA", img:"Mashrabya.jpeg", price:5500,newPrice:4500,discount:true, zoom:1., position:"50% 65%", stock:true},
    {name:"ODYSSEY AQUA", brand:"ARMAF", img:"OdysseyAqua.jpeg", price:7000,newPrice:6000,discount:true, zoom:1.1, position:"50% 67%", stock:true},
    {name:"ODYSSEY LIMONI", brand:"ARMAF", img:"OdysseyLimoni.jpeg", price:6500,discount:true, zoom:1.2, position:"50% 67%", stock:false},
    {name:"OUD FOR GLORY", brand:"LATTAFA", img:"OudForGlory.jpeg", price:5500,newPrice:4500,discount:true, zoom:1.1, position:"50% 62%", stock:true},
    {name:"SALVO EDP", brand:"MAISON ALHAMBRA", img:"SalvoEDP.jpeg", price:5500,newPrice:4500,discount:true, zoom:1., position:"50% 62%", stock:true},
    {name:"SCEPTRE MALACHITE", brand:"MAISON ALHAMBRA", img:"SceptreMalachite.jpeg", price:6000,newPrice:5000,discount:true, zoom:1., position:"50% 65%", stock:true},
    {name:"SPECTRE GHOST", brand:"FRENCH AVENUE", img:"SpectreGhost.jpeg", price:9500,newPrice:8500, discount:true, zoom:1.2, position:"50% 60%", stock:true},
    {name:"TERIAQ INTENSE", brand:"LATTAFA", img:"TeriaqIntense.jpeg", price:6000,newPrice:5000,discount:true, zoom:1., position:"50% 67%", stock:true},
    {name:"THE KINGDOM", brand:"LATTAFA", img:"TheKingdom.jpeg", price:6500,newPrice:5500,discount:true, zoom:1., position:"50% 68%", stock:true},
    {name:"TOY BOY", brand:"MOSCHINO", img:"ToyBoy.jpeg", price:13000,newPrice:12000,discount:true, zoom:1., position:"50% 65%", stock:true},
    {name:"URBAN MAN ELIXIR", brand:"ARMAF", img:"UrbanManElixir.jpeg", price:6500,newPrice:5500,discount:true, zoom:1., position:"50% 61%", stock:true},
    {name:"VICTORIOSO NERO", brand:"MAISON ALHAMBRA", img:"VictoriosoNero.jpeg", price:5000,newPrice:4000,discount:true, zoom:1., position:"50% 62%", stock:true},
    {name:"WAJOOD", brand:"LATTAFA", img:"Wajood.jpeg", price:7500,newPrice:6500,discount:true, zoom:1.1, position:"50% 70%", stock:true},
    {name:"VINTAGE RADIO", brand:"LATTAFA", img:"VintageRadio.jpeg", price:6000,newPrice:5000,discount:true, zoom:1., position:"50% 60%", stock:true},
	{name:"9PM NIGHT OUT", brand:"AFNAN", img:"9PMNightOut.jpeg", price:8000,newPrice:7000,discount:true, zoom:1.2, position:"50% 55%", stock:true},
    {name:"ASAD ELIXIR", brand:"LATTAFA", img:"AsadElixir.jpeg", price:6500,newPrice:5500,discount:true, zoom:1., position:"50% 48%", stock:true},
    {name:"DETOUR NOIR", brand:"AL HARAMAIN", img:"DetourNoir.jpeg", price:6000,newPrice:5000,discount:true, zoom:1., position:"50% 55%", stock:true},
    ...
    {name:"HAWAS FIRE", brand:"RASASI", img:"HawasFire.jpeg", price:7500,newPrice:6500,discount:true, zoom:1., position:"50% 48%", stock:true},
    ...
    {name:"LIQUID BRUN", brand:"FRENCH AVENUE", img:"LiquidBrun.jpeg", price:8000,newPrice:7000,discount:true, zoom:1.1, position:"50% 53%", stock:true},
	{name:"HAWAS MALIBU", brand:"RASASI", img:"HawasMalibu.jpeg", price:7500,newPrice:6500,discount:true, zoom:1., position:"50% 50%", stock:true},
	...
	{name:"VULCAN FEU", brand:"FRENCH AVENUE", img:"VulcanFeu.jpeg", price:7500,newPrice:6500, discount:true, zoom:1.2, position:"50% 50%", stock:true},
	{name:"QAED AL FURSAN UNTAMED", brand:"LATTAFA", img:"Untamed.jpeg", price:5000,newPrice:4000,discount:true, zoom:1.1, position:"50% 37%", stock:true},
	{name:"AMBER OUD DUBAI NIGHT", brand:"AL HARAMAIN", img:"DubaiNight.jpeg", price:8500,newPrice:7500,discount:true, zoom:1., position:"50% 50%", stock:true},
    {name:"AMBER OUD GOLD EDITION", brand:"AL HARAMAIN", img:"GoldEdition.jpeg", price:8500,newPrice:7500,discount:true, zoom:1., position:"50% 63%", stock:true}
];

// ===== FRASCOS =====
const full = [
    {name:"LIQUID BRUN", brand:"FRENCH AVENUE", img:"LiquidBrun.jpeg", price:90000,newPrice:85000,discount:true, zoom:1.1, position:"50% 53%", stock:true},
	{name:"VULCAN FEU", brand:"FRENCH AVENUE", img:"VulcanFeu.jpeg", price:85000,newPrice:80000, discount:true, zoom:1.2, position:"50% 50%", stock:true},
	{name:"PHILOS PURA", brand:"MAISON ALHAMBRA", img:"PhilosPura.jpeg", price:60000,newPrice:57000,discount:true, zoom:1., position:"50% 40%", stock:true},
    ...
    {name:"9PM ELIXIR", brand:"AFNAN", img:"9PMElixir.jpeg", price:90000,newPrice:85000, discount:true, zoom:1., position:"50% 68%", stock:true},
    {name:"AL NOBLE SAFEER", brand:"LATTAFA", img:"AlNobleSafeer.jpeg", price:8000, zoom:1., position:"80% 55%", stock:false},
	{name:"VINTAGE RADIO", brand:"LATTAFA", img:"VintageRadio.jpeg", price:65000,newPrice:60000, discount:true, zoom:1., position:"50% 60%", stock:true},
    ...
    {name:"ASAD BOURBON", brand:"LATTAFA", img:"AsadBourbon.jpeg", price:67000,newPrice:62000, discount:true, zoom:1.1, position:"50% 60%", stock:true},
