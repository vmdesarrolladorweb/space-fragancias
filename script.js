...
const decants = [
    ...
    {name:"ASAD", brand:"LATTAFA", img:"Asad.jpeg", price:6500,newPrice:5000,discount:false, zoom:1., position:"50% 67%", stock:true},
    {name:"ASAD BOURBON", brand:"LATTAFA", img:"AsadBourbon.jpeg", price:7000,newPrice:5500,discount:false, zoom:1.1, position:"50% 60%", stock:true},
    {name:"EROS FLAME", brand:"VERSACE", img:"ErosFlame.jpeg", price:14500,newPrice:13000,discount:false, zoom:1.2, position:"50% 65%", stock:true},
    {name:"EXTRAVAGANT LOVER", brand:"MAISON ALHAMBRA", img:"Extravagantlover.jpeg", price:5500,newPrice:5000,discount:false, zoom:1.1, position:"50% 67%", stock:true},
    {name:"FAKHAR PLATIN", brand:"LATTAFA", img:"FakharPlatin.jpeg", price:6000,newPrice:4500,discount:false, zoom:1., position:"50% 50%", stock:true},
    {name:"HAWAS ICE", brand:"RASASI", img:"HawasIce.jpeg", price:8000,newPrice:6500,discount:false, zoom:1.1, position:"50% 64%", stock:true},
    {name:"HIS CONFESSION", brand:"MAISON ALHAMBRA", img:"HisConfession.jpeg", price:7000,newPrice:5500,discount:false, zoom:1., position:"50% 47%", stock:true},
    {name:"HONOR & GLORY", brand:"LATTAFA", img:"HonorGlory.jpeg", price:6000,newPrice:4500,discount:false, zoom:1.1, position:"50% 65%", stock:true},
    {name:"INTENSE MAN", brand:"ARMAF", img:"IntenseMan.jpeg", price:7000,newPrice:6000,discount:false, zoom:1., position:"50% 55%", stock:true},
    {name:"ISHQ AL SHUYUKH", brand:"LATTAFA", img:"IshqAlShuyukh.jpeg", price:6500,newPrice:5000,discount:false, zoom:1., position:"50% 63%", stock:true},
    {name:"JASOOR", brand:"LATTAFA", img:"Jasoor.jpeg", price:6500,newPrice:5500,discount:false, zoom:1., position:"50% 65%", stock:true},
    {name:"KHAMRAH QAHWA", brand:"LATTAFA", img:"KhamrahQahwa.jpeg", price:6000,newPrice:4500,discount:false, zoom:1.2, position:"50% 65%", stock:true},
    {name:"MASHRABYA", brand:"LATTAFA", img:"Mashrabya.jpeg", price:6000,newPrice:4500,discount:false, zoom:1., position:"50% 65%", stock:true},
    {name:"ODYSSEY AQUA", brand:"ARMAF", img:"OdysseyAqua.jpeg", price:7500,newPrice:6000,discount:false, zoom:1.1, position:"50% 67%", stock:true},
    {name:"ODYSSEY LIMONI", brand:"ARMAF", img:"OdysseyLimoni.jpeg", price:7000,discount:false, zoom:1.2, position:"50% 67%", stock:false},
    {name:"OUD FOR GLORY", brand:"LATTAFA", img:"OudForGlory.jpeg", price:6000,newPrice:4500,discount:false, zoom:1.1, position:"50% 62%", stock:true},
    {name:"SALVO EDP", brand:"MAISON ALHAMBRA", img:"SalvoEDP.jpeg", price:6000,newPrice:4500,discount:false, zoom:1., position:"50% 62%", stock:true},
    {name:"SCEPTRE MALACHITE", brand:"MAISON ALHAMBRA", img:"SceptreMalachite.jpeg", price:6500,newPrice:5000,discount:false, zoom:1., position:"50% 65%", stock:false},
    {name:"SPECTRE GHOST", brand:"FRENCH AVENUE", img:"SpectreGhost.jpeg", price:10000,newPrice:9000, discount:true, zoom:1.2, position:"50% 60%", stock:true},
    {name:"TERIAQ INTENSE", brand:"LATTAFA", img:"TeriaqIntense.jpeg", price:6500,newPrice:5000,discount:false, zoom:1., position:"50% 67%", stock:true},
	{name:"NITRO WHITE", brand:"DUMONT", img:"NitroWhite.jpeg", price:7000,newPrice:6000,discount:false, zoom:1., position:"50% 52%", stock:true},
    {name:"THE KINGDOM", brand:"LATTAFA", img:"TheKingdom.jpeg", price:6500,newPrice:6000,discount:false, zoom:1., position:"50% 68%", stock:true},
    {name:"TOY BOY", brand:"MOSCHINO", img:"ToyBoy.jpeg", price:13000,newPrice:12500,discount:false, zoom:1., position:"50% 65%", stock:true},
    {name:"URBAN MAN ELIXIR", brand:"ARMAF", img:"UrbanManElixir.jpeg", price:7000,newPrice:5500,discount:false, zoom:1., position:"50% 61%", stock:true},
    {name:"VICTORIOSO NERO", brand:"MAISON ALHAMBRA", img:"VictoriosoNero.jpeg", price:5500,newPrice:4000,discount:false, zoom:1., position:"50% 62%", stock:true},
    {name:"WAJOOD", brand:"LATTAFA", img:"Wajood.jpeg", price:7500,newPrice:7000,discount:false, zoom:1.1, position:"50% 70%", stock:true},
    {name:"VINTAGE RADIO", brand:"LATTAFA", img:"VintageRadio.jpeg", price:6500,newPrice:5000,discount:false, zoom:1., position:"50% 60%", stock:true},
	...
	{name:"MANDARIN SKY", brand:"ARMAF", img:"MandarinSky.jpeg", price:6500,newPrice:5500, discount:true, zoom:1., position:"50% 55%", stock:true},
	...
	{name:"HAWAS MALIBU", brand:"RASASI", img:"HawasMalibu.jpeg", price:8000,newPrice:6500,discount:false, zoom:1., position:"50% 50%", stock:true},
	{name:"HAWAS TROPICAL", brand:"RASASI", img:"HawasTropical.jpeg", price:8000,newPrice:6500,discount:false, zoom:1., position:"50% 47%", stock:true},
...
const full = [
    ...
    {name:"AL QIAM GOLD", brand:"LATTAFA", img:"AlQiamGold.jpeg", price:60000, zoom:1., position:"50% 60%", stock:true},
